...
-- SELECT * FROM sh.CUSTOMERS where CUST_CITY= 'California' [here "caifornia" city does not exist ]
...
-- SELECT * FROM sh.CUSTOMERS where CUST_EFF_FROM > '12/31/2021, 23:59:59'

-- 19. Retrieve customers whose effective end date (`CUST_EFF_TO`) is before 2021.
-- SELECT * FROM sh.CUSTOMERS where CUST_EFF_TO < '12/31/2021, 23:59:59'
